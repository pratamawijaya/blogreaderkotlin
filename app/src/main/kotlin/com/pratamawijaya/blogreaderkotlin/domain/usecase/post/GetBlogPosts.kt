 ...
 */
class GetBlogPosts @Inject constructor(threadExecutor: ThreadExecutor,
    postExecutionThread: PostExecutionThread,
    private val repository: PostRepository) : UseCase<List<Post>, GetBlogPosts.Params>(
  ...
  class Params private constructor(val page: Int, val isUpdate: Boolean) {
    companion object {
      fun createParams(page: Int, isUpdate: Boolean): Params {
